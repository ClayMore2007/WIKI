...
sources:
  ...
  - [[Wiki/30-技术知识/AI与大模型/Claude-Code-Skills推荐]]
...
| 内容创作自动化 | 本地知识、Claude Code、配图和版本控制 | 已整理 [[Wiki/30-技术知识/AI与大模型/Obsidian-Claude-Code内容创作自动化流程]] |
...
- 2026-05-11 新增一条 B 站线索：Obsidian + Claude Code + Nano Banana 内容创作自动化。已用 `yt-dlp` 获取 metadata，并通过 `faster-whisper` 生成机器转写稿；已沉淀为 [[Wiki/30-技术知识/AI与大模型/Obsidian-Claude-Code内容创作自动化流程]]，专有名词仍需核验。

## 重要来源

- [[Wiki/30-技术知识/AI与大模型/Claude-Code-Skills推荐]]
- [[Wiki/30-技术知识/AI与大模型/Cubox-AI资料索引]]
- [[Wiki/30-技术知识/AI与大模型/Obsidian-Claude-Code内容创作自动化流程]]
